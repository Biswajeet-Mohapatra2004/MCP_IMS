...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleWarehouseInUse(WarehouseInUseException ex) {
        return buildResponse(HttpStatus.CONFLICT, ex.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleSupplierInUse(SupplierInUseException ex) {
        return buildResponse(HttpStatus.CONFLICT, ex.getMessage());
    }
